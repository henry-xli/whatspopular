export const accountSchemaStatements = [
  ...
  "CREATE INDEX IF NOT EXISTS idx_auth_email_change_user ON auth_email_change_challenges(user_id, status, expires_at)",
  "CREATE INDEX IF NOT EXISTS idx_auth_email_change_email ON auth_email_change_challenges(new_email, status, expires_at)",
