...
export const metadata: Metadata = {
  title: "About",
  description: "A concise overview of the 48-hour source, validation, and publishing flow behind what’s popular?.",
  ...
  return (
    <main className="about-page" id="main-content" tabIndex={-1}>
      <section className="about-hero wrap">
        ...
        <p>
          Every 48 hours, what’s popular? pulls public data, builds the eight
