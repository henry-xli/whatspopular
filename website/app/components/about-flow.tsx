const flow = [
  ...
  {
    number: "02",
    title: "Ingest every day",
    text: "One automated job runs at 12:00 AM Pacific, with a short recovery window for a delayed runner. Visitors never trigger scraping or source requests.",
  },
  {
    number: "03",
