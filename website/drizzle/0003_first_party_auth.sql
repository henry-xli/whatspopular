...
CREATE INDEX IF NOT EXISTS idx_auth_verification_email
  ON auth_verification_challenges(email, status, expires_at);
...
CREATE INDEX IF NOT EXISTS idx_auth_mobile_codes_expiry
  ON auth_mobile_codes(expires_at, used_at);
